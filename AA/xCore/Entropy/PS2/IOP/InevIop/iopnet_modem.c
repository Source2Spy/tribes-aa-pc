...
net_connect_status *NetConnectStatus(void)
{
	...
	sceInetInterfaceControl(g_Net.m_LastLoadedDeviceId, scePPPCC_GetLastResultString, module_name, sizeof(module_name));
	...
	g_Net.m_ConnectStatus.ConnectSpeed = Speed;
