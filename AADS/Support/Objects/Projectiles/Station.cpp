...
void station::DeployBeacon( void ) const
{
    // See if there is already a beacon nearby.
    ObjMgr.Select( ATTR_BEACON, m_WorldPos, 1.1f );
    ...
    {    
        ...
        if( Ray.HasCollided() )
        {
            ...
            pBeacon->Initialize( Collision.Point, Collision.Plane.Normal, m_TeamBits );
