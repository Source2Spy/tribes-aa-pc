...
virtual xbool   FlagHitPlayer   ( object::id FlagID,   object::id PlayerID  );
...
virtual object::id GetFlagID    ( s32 Index );
...
//      void    WriteFinalScore ( void );
//rtual void    WriteScoreData  ( X_FILE* pFile );
