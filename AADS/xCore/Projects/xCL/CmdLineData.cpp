...
{   
    ...
    else if( strncmp( m_TargetString+6, "_LINUX",   6 ) == 0 )      m_Target = TARGET_LINUX;
	...
	else if( strncmp( m_VendorString+6, "_CYGNUS", 6 ) == 0 )  m_Vendor = VENDOR_CYGNUS; 
...
void cmd_line_data::Dump( void )
{
    ...
    char* pTargetName[] = { "<unknown>", "PC", "PS2", "PS2 IOP", "X-Box", "GameCube", "Linux" };
    char* pVendorName[] = { "<unknown>", "Microsoft", "SN Systems", "Metrowerks", "Linux" };
