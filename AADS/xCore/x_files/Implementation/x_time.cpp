...
void x_TimeInit( void )
{
		...
		s_UnixBaseTick = (xtick)tv.tv_sec*1000000 + (xtick)tv.tv_usec;
}
...
xtick x_GetTime( void )
{
		...
		Ticks = (xtick)tv.tv_sec * 1000000 + (xtick)tv.tv_usec;
    return( Ticks - s_UnixBaseTick);
}
