...
{ 
    ...
    case 1: // Audio subsystem
        ...
        break;
    case 2: // Network subsystem
        ret = net_Dispatch(command,data,size);
        break;
    default:
...
//-----------------------------------------------------------------------------
sceSifQueueData QueueData __attribute__((aligned(16)));
sceSifServeData ServerData __attribute__((aligned(16)));
s32 iop_loop(void)
{
#ifdef X_DEBUG
#endif
